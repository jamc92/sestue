            ...
            fire: function () {
                ...
                return function (k, h, l) {
                    ...
                    if (m) {
                        var o = m.listeners;
                        if (o.length)
                            for (var o = o.slice(0), i, q = 0; q < o.length; q++) {
                                if (m.errorProof) try {
                                    i = o[q].call(this,
                                        l, h, b, g)
    ...
    (function () {
        function b(a, b) {
            ...
            if (this.current) d = this.current[e](false, f, i);
                ...
                if (a) d.type ==
                    CKEDITOR.NODE_ELEMENT && (d = o > 0 ? d.getChild(o - 1) : i(d, true) === false ? null : d.getPreviousSourceNode(true, f, i));
                else {
                    d = m;
        ...
        var f = function (a) {
            a.collapsed = a.startContainer && a.endContainer && a.startContainer.equals(a.endContainer) && a.startOffset == a.endOffset
                ...
                for (o = h; o < j.length; o++) {
                    ...
                    if (!f[o] || r.$.parentNode != f[o].$.parentNode)
                                ...
                                if (e.type == CKEDITOR.NODE_TEXT) {
                                    ...
                                    if (k && CKEDITOR.dtd.$removeEmpty[e.getName()]) {
                                        ...
                                        if (/[^\s\ufeff]/.test(l)) e = null;
                                            ...
                                            for (var u = e.$.getElementsByTagName("*"), r = 0, F; F = u[r++];)
            ...
            shrink: function (a, b, c) {
                if (!this.collapsed) {
                    ...
                    if (d && d.type == CKEDITOR.NODE_TEXT)
                        if (f)
                            if (f >= d.getLength()) i.setStartAfter(d);
                            else {
                                i.setStartBefore(d);
                                k = 0
                    ...
                    if (g && g.type == CKEDITOR.NODE_TEXT)
                        if (e)
                            if (e >= g.getLength()) i.setEndAfter(g);
                            else {
                                i.setEndAfter(g);
                                h = 0
                        ...
                        if (--k <= 0) {
                            ...
                            if (b[a]) n(a, true);
                                ...
                                if (!(d.length >
                                    ...
                                    if (f)
                                        if (CKEDITOR.env.ie) i.$.onreadystatechange = function () {
            ...
            var d = {}, g = function (a) {
                    b.call(this, a, function (a) {
                        ...
                        for (k in a) {
                            ...
                            if (!c[k]) {
                                if (n.icons)
                                    for (var i = n.icons.split(","), q = 0; q < i.length; q++) CKEDITOR.skin.addIcon(i[q], n.path + "icons/" + i[q] + ".png");
                                c[k] = 1
                            }
                            if (o) {
                                o.split && (o = o.split(","));
    ...
    (function () {
        function b(b, i, n) {
            ...
            if (i !== void 0) {
                ...
                } else throw Error("Expect element of type CKEDITOR.dom.element."); if (CKEDITOR.env.ie && CKEDITOR.env.quirks && n == CKEDITOR.ELEMENT_MODE_INLINE) throw Error("Inline element mode is not supported on IE quirks.");
                ...
                if (b(n)) y.push(n);
                    ...
                    if (d == "pre") A = true;
                        ...
                        for (;;) {
                            ...
                            if (!n.isUnknown && !j.isUnknown && !e[d])
                                if (j.isOptionalClose) i.onTagClose(g);
    ...
    (function () {
                ...
                return function (i) {
                    if (i.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var e = [],
                            ...
                            j, K;
                        if (g)
                            for (o(g, 1) && e.push(g); g;) {
                                if (d(g) && (j = f(g)) && o(j))
                                    if ((K = f(j)) && !d(K)) e.push(j);
                                    else {
                                        var h = j,
                                            q = n(t),
                                            l = h.parent.children,
                        ...
                        if (e = CKEDITOR.env.opera && !b || (typeof c == "function" ? c(i) !== false : c))
                            if (!t && CKEDITOR.env.ie && i.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) e = false;
        ...
        function j(a, b) {
            for (var c = [], d = b.config.protectedSource, n = b._.dataStore || (b._.dataStore = {
                    id: 1
                }), i = /<\!--\{cke_temp(comment)?\}(\d*?)--\>/g, d = [/<script[\s\S]*?<\/script>/gi,
                ...
                insertElement: function (b) {
                    ...
                    for (var c =
                        ...
                        if (!m.checkReadOnly()) {
                            ...
                            if (j)
                                for (;
                                    (D = m.getCommonAncestor(0, 1)) && (u = CKEDITOR.dtd[D.getName()]) && (!u || !u[l]);)
                                    if (D.getName() in CKEDITOR.dtd.span) m.splitElement(D);
                    ...
                    if (B) {
                        ...
                        if (j)
                            if ((b = B.getNext(a)) && b.type == CKEDITOR.NODE_ELEMENT && b.is(CKEDITOR.dtd.$block)) b.getDtd()["#"] ? m.moveToElementEditStart(b) : m.moveToElementEditEnd(B);
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in {
                                ...
                                if (i = e(i)) {
                                    ...
                                    if ((o = f.block) && b[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && (l = o[c ? "getPrevious" : "getNext"](h)) && l.is("table")) {
                                        a.fire("saveSnapshot");
                                    ...
                                    if ((l = g[c ? "getPreviousSourceNode" : "getNextSourceNode"](1, CKEDITOR.NODE_ELEMENT)) && !l.isReadOnly() && b.root.contains(l)) {
                                        b[c ?
                        ...
                        for (h(I, E); w < I.length; w++) {
                            ...
                            if (x) v = w > 0;
                                ...
                                if (P) {
                                    ...
                                    P = 0
                                } else E.insertNode(G.node); if (G.lastNotAllowed && w < I.length - 1) {
                    ...
                    if (this.isLocked) {
                        ...
                        if (l) {
                            ...
                            if (A && A.type == CKEDITOR.NODE_ELEMENT && A.getName() in m && (!A.is("a") || !A.getText())) try {
                                ...
                                k.select();
                                return
                            } catch (B) {}(b.startContainer.type == CKEDITOR.NODE_ELEMENT && b.startContainer.getName() in g || b.endContainer.type == CKEDITOR.NODE_ELEMENT &&
                        ...
                        if (!r || i[r] && !s && (!q || h) && (k.getPosition(m) | CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule || e.childRule(k))) {
                            ...
                            if (u && ((u.getDtd() || CKEDITOR.dtd.span)[d] || f) && (!e.parentRule || e.parentRule(u))) {
                                ...
                                if (p == CKEDITOR.NODE_TEXT || q || p == CKEDITOR.NODE_ELEMENT && !k.getChildCount()) {
                                    for (var p = k, v;
                                        (g = !p.getNext(F)) && (v = p.getParent(), i[v.getName()]) && (v.getPosition(j) | CKEDITOR.POSITION_FOLLOWING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_FOLLOWING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule ||
                                            e.childRule(v));) p = v;
                                    n.setEndAfter(p)
                                }
                            } else g = true
                        ...
                        for (var g = y(this, c), q = g.hasAttributes(), s = n.getCommonAncestor(), p = {}, r = {}, u = {}, z = {}, A, B, D; g && s;) {
                            if (s.getName() == d) {
                                for (A in e.attributes)
                                    if (!z[A] && (D = s.getAttribute(B))) g.getAttribute(A) == D ? r[A] = 1 : z[A] = 1;
                                for (B in e.styles)
                                    if (!u[B] && (D = s.getStyle(B))) g.getStyle(B) == D ? p[B] = 1 : u[B] = 1
                            }
                            s = s.getParent()
                        }
...
*/
            ...
            addPage: function (a) {
                ...
                var d = CKEDITOR.env,
                    ...
                    c = CKEDITOR.dom.element.createFromHtml(['<a class="cke_dialog_tab"',
                        0 < this._.pageCount ? " cke_last" : "cke_first", c, a.hidden ? ' style="display:none"' : "", ' id="', g, '"', d.gecko && 10900 <= d.version && !d.hc ? "" : ' href="javascript:void(0)"', ' tabIndex="-1" hidefocus="true" role="tab">', a.label, "</a>"
                    ].join(""));
                    ...
                    if (e) {
                        if ("top" == e && i.top < o ? j("pin") : "pin" == e ? b.top > m + k ? j("top") : b.bottom - i.bottom < k && j("bottom") : "bottom" == e && (b.top > m + k ? j("top") : b.bottom > 2 * k + o && j("pin")), p) {
                            var d = g.getViewPaneSize(),
                                s = d.width / 2,
                                i = 0 < b.left && b.right < d.width && b.width >
                        ...
                        c = {
                            ...
                            execute: function (c) {
                                ...
                                if (d.state != CKEDITOR.TRISTATE_DISABLED)
                                    if (f.createPanel(a), d.on) d.panel.hide();
                                    else {
                                        f.commit();
                                        var b = f.getValue();
    ...
    (function () {
        ...
        function T(a) {
            ...
            else return null; if (n(f) || aa(a, f, i) || f.getParent().is(U)) return null;
            var j = L(a, f, !i);
            if (j) {
    ...
    CKEDITOR.plugins.removeformat = {
        ...
        filter: function (a, h) {
            for (var e = a._.removeFormat.filters, f = 0; f < e.length; f++)
                if (!1 === e[f](h)) return !1;
            return !0
        }
    };
            ...
            for (var c = c.getRanges(), b = [], a = {}, e = 0; e < c.length; e++) {
                ...
                if (f.collapsed) f = f.getCommonAncestor(), (f = f.getAscendant("td", !0) || f.getAscendant("th", !0)) && b.push(f);
                    ...
                    for (f.guard = d; g = f.next();)
                        if ((g = g.getAscendant("td") || g.getAscendant("th")) && !g.getCustomData("selected_cell")) CKEDITOR.dom.element.setMarker(a,
            ...
            init: function (c) {
                ...
                c.addCommand("columnDelete", d({
                    exec: function (a) {
                        ...
                        for (k = h; k <= i; k++)
                            for (l = 0; l < d.length; l++) c = d[l], b = new CKEDITOR.dom.element(a.$.rows[l]), c = new CKEDITOR.dom.element(c[k]), c.$ && (1 == c.$.colSpan ? c.remove() : c.$.colSpan -= 1, l += c.$.rowSpan - 1, b.$.cells.length || j.push(b));
